...
public class MainActivity extends AppCompatActivity {
    ...
    ForecastAdapter mForecastadapterVariable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mForecastadapterVariable = new ForecastAdapter();
        // TODO (42) Use mRecyclerView.setAdapter and pass in mForecastAdapter
        mRecyclerView.setAdapter(mForecastadapterVariable);
        /*
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                 ...
                 */
                mForecastadapterVariable.setWeatherData(weatherData);
            } else {
                showErrorMessage();
            }
        }
